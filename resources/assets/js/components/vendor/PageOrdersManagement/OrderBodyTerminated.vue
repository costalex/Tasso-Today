    ...
    <div id="BoddyCoreCommandeTerminee">
        ...
        <div v-if="select_name">
            ...
            <div
                ...
                :key="element.id"
            >
                <div v-if="element.statut == 'TERMINE'">
                    <div
                        id="TopCommande"
                    ...
                    >
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3 no-padding">
                            <div>
                                Download Facture:
                                <button @click="Download_bill(element.num_commande)">
                                    FACTURE ICONE
                                </button>
                            </div>
                        </div>
    ...
    data: () => {
        return {
            ...
            gridColumns: [
                ...
                { key: 'stocks', value: 'model' },
                { key: 'couleur', value: 'couleur' },
                { key: 'quantite', value: 'quantite' },
                { key: 'prix', value: 'prix' }
            ],
