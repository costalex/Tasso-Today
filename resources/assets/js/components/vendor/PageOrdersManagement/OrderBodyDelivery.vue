<template>
    <div id="BoddyCoreCommandeTerminee">
        <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
            ...
            <div class="col-md-2 col-sm-2 col-xs-2 no-padding">
                <p class="text-accepted-order">
                    {{ num_livraison }} <span>en cours de livraison</span>
                </p>
            </div>
        </div>
        ...
        <div v-if="select_name">
            ...
            <div
                ...
                :key="element.id"
            >
                <div v-if="element.statut === 'EN_COURS'">
                    <div
                        id="TopCommande"
                    ...
                    >
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3 no-padding">
                            <p>la commande est en cour de livraison</p>
                        </div>
                    </div>
            ...
            >
                <div v-if="element.statut === 'EN_COURS'">
                    ...
                    >
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3 no-padding">
                            <p >la commande est en cours de livraison</p>
                        </div>
                    </div>
...
export default {
        ...
        num_livraison: {
            get () {
                ...
                for (let i in commandes) {
                    if (commandes[i].statut === 'EN_COURS') {
                        returnNum++;
                    }
                }
    ...
    methods: {
        ...
        Download_bill (num) {
            this.$store.commit('SET_REF_BILL', num);
            this.$store.dispatch('DOWLOAD_BILL');
        }
    }
};
</script>
